...
angular.module("acComponents.templates", []).run(["$templateCache", function($templateCache) {$templateCache.put("drawer.html","<div class=\"ac-drawer\"><a ng-click=\"drawer.visible = false\" class=\"ac-drawer-close visible-xs\"><i class=\"fa fa-close fa-lg\"></i></a><div class=\"ac-drawer-tools\"><ul><li ng-click=\"drawer.visible = !drawer.visible\" style=\"height: 55px;\"><i class=\"fa fa-file-text-o fa-fw fa-2x fa-inverse ac-middle\"></i></li><li ng-click=\"toggleFilter()\" ng-class=\"{on: filters.obsPeriod !== \'\'}\" style=\"color: white; height: 55px; padding-top: 5px; padding-left: 15px;\"><i style=\"display: block;\" class=\"fa fa-map-marker fa-inverse fa-2x\"></i><span>{{ filters.obsPeriod !== \'\' ? \'on\' : \'off\' }}</span></li></ul></div><div ng-transclude=\"ng-transclude\" class=\"ac-drawer-body\"></div></div>");
