...
$templateCache.put("hot-zone-report-fullpage.html","<div class=\"panel\"><div class=\"panel-body\"><div class=\"row\"><header class=\"col-xs-12\"><div id=\"header-inner\"><h1>{{ report.hotzoneid | acCapitalize }} Pilot Project</h1><div ng-click=\"print()\" class=\"section-label print-link pull-right\"><i class=\"fa fa-external-link\"></i><span>&nbsp; Print Friendly</span></div></div></header><section id=\"forecast-date\" class=\"col-xs-12\"><div id=\"date-issued\" class=\"forecast-date-inner\">Date Issued &nbsp;<br class=\"visible-xs-inline\"/><span> {{ formatDate(report.report.dateissued) | date:\'EEE MMMM d, h:mm a\' | uppercase }}</span></div><div id=\"date-valid\" style=\"width: 574px;\" class=\"forecast-date-inner\">&nbsp; Valid Until &nbsp;<br class=\"visible-xs-inline\"/><span>{{ formatDate(report.report.datevalid) | date:\'EEE MMMM d, h:mm a\' | uppercase }}</span></div><div id=\"date-issued\" ng-if=\"report.user\" class=\"forecast-date-inner\">Forecaster &nbsp;<br class=\"visible-xs-inline\"/><span>{{ report.user }}</span></div><div id=\"date-valid\" ng-if=\"report.user\" style=\"width: 574px;\" class=\"forecast-date-inner\"></div></section><section id=\"forecast-body\" class=\"col-xs-12 col-md-12\"><div id=\"highlights\"><h2>{{report.report.headline}}</h2></div><div ng-if=\"report.report.uploads.length &gt; 0\" class=\"upload-n-share\"><div class=\"row-fluid observation-title\">Uploads</div><div class=\"row\"><div class=\"col-sm-12 section-label\"><i class=\"fa fa-camera\"></i><span>Uploads (click/tap to enlarge)</span></div><div class=\"col-sm-12\"><ul class=\"list-inline\"><li ng-repeat=\"url in report.report.thumbs\"><a ng-href=\"{{::url}}\" target=\"_blank\"></a><img ng-src=\"{{::url}}\" width=\"75\" alt=\"{{::report.report.headline}}\"/></li></ul></div></div></div><div class=\"panel-group\"><div class=\"panel panel-primary\"><div class=\"panel-heading\">Critical Factors Summary</div><div class=\"panel-body\"><div class=\"row\"><div class=\"col-xs-12\">Critical factors influence avalanche hazard. The more critical factors, the greater the potential for avalanches.</div></div><div class=\"row\"><div class=\"col-xs-6 sm-pad-right\"><strong class=\"pull-right text-right\">Persistent avalanche problem:</strong></div><div class=\"col-xs-6 sm-pad-left\">{{ report.report.data.criticalFactors.persistentAvalancheProblem || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6 sm-pad-right\"><strong class=\"pull-right text-right\">Slab avalanches in the last 48 hours:</strong></div><div class=\"col-xs-6 sm-pad-left\">{{ report.report.data.criticalFactors.slabAvalanches || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6 sm-pad-right\"><strong class=\"pull-right text-right\">Signs of instability:</strong></div><div class=\"col-xs-6 sm-pad-left\">{{ report.report.data.criticalFactors.instability || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6 sm-pad-right\"><strong class=\"pull-right text-right\"> Recent snowfall > 30cm:</strong></div><div class=\"col-xs-6 sm-pad-left\">{{ report.report.data.criticalFactors.recentSnowfall || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6 sm-pad-right\"><strong class=\"pull-right text-right\"> Recent rainfall:</strong></div><div class=\"col-xs-6 sm-pad-left\">{{ report.report.data.criticalFactors.recentRainfall || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6 sm-pad-right\"><strong class=\"pull-right text-right\"> Recent windloading:</strong></div><div class=\"col-xs-6 sm-pad-left\">{{ report.report.data.criticalFactors.recentWindloading || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6 sm-pad-right\"><strong class=\"pull-right text-right\"> Significant warming:</strong></div><div class=\"col-xs-6 sm-pad-left\">{{ report.report.data.criticalFactors.significantWarming || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-12 text-center\"><strong>Comments</strong></div><div class=\"col-xs-12 text-center\">{{ report.report.criticalFactors.criticalFactorsComments || \'N/A\' }}</div></div></div></div><div class=\"panel panel-primary\"><div class=\"panel-heading\">Terrain and Travel Advice</div><div class=\"panel-body\"><div class=\"row\"><div class=\"col-xs-12\">To minimize risk, always:<ul><li>Expose only one person at a time in avalanche terrain.</li><li>Group up only in safe locations well away from avalanche runout zones.</li><li>Avoid terrain traps whenever possible.</li></ul></div></div><div class=\"row\"><div class=\"col-xs-12\">And while this report is valid:<ul><li>AVOID terrain features marked with an &nbsp;<i class=\"fa fa-times-circle-o\"></i></li><li>Follow the advice in the comments section.</li></ul></div></div><div class=\"row\"><div class=\"col-xs-12 terrain-title\"><h4>ALPINE</h4></div></div><div class=\"row\"><div class=\"col-xs-6\"><div class=\"row\"><div class=\"col-xs-12\"><strong>Aspect:</strong></div></div><div class=\"row\"><div class=\"col-xs-12\"><ul class=\"terrain-list\"><li ng-repeat=\"(name, value) in report.report.data.alpineTerrainAvoidance.aspect\" ng-class=\"{\'terrain-highlight\': value}\"><div class=\"row\"><div class=\"col-xs-2 terrain-icon\"><i ng-class=\"{\'fa-square-o\': !value, \'fa-check-square-o\': value}\" class=\"fa\"></i></div><div class=\"col-xs-10\"><span class=\"pull-left\">{{ name }}</span></div></div></li></ul></div></div></div><div class=\"col-xs-6\"><div class=\"row\"><div class=\"col-xs-12\"><strong>Terrain features:</strong></div></div><div class=\"row\"><div class=\"col-xs-12\"><ul class=\"terrain-list\"><li ng-repeat=\"(name, value) in report.report.data.alpineTerrainAvoidance.terrainFeatures\" ng-class=\"{\'terrain-highlight\': value}\"><div class=\"row\"><div class=\"col-xs-2 terrain-icon\"><i ng-class=\"{\'fa-circle-o\': !value, \'fa-times-circle-o\': value}\" class=\"fa\"></i></div><div class=\"col-xs-10\"><span class=\"pull-left\">{{ name }}</span></div></div></li></ul></div></div></div></div><div class=\"row\"><div class=\"col-xs-12\"><strong>Comments</strong></div><div class=\"col-xs-12\">{{ report.report.data.alpineTerrainAvoidance.terrainAvoidanceComments || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-12\"><h4>TREELINE:</h4></div></div><div class=\"row\"><div class=\"col-xs-6\"><div class=\"row\"><div class=\"col-xs-12\"><strong>Aspect:</strong></div></div><div class=\"row\"><div class=\"col-xs-12\"><ul class=\"terrain-list\"><li ng-repeat=\"(name, value) in report.report.data.treelineTerrainAvoidance.aspect\" ng-class=\"{\'terrain-highlight\': value}\"><div class=\"row\"><div class=\"col-xs-2 terrain-icon\"><i ng-class=\"{\'fa-circle-o\': !value, \'fa-times-circle\': value}\" class=\"fa\"></i></div><div class=\"col-xs-10\"><span class=\"pull-left\">{{ name }}</span></div></div></li></ul></div></div></div><div class=\"col-xs-6\"><div class=\"row\"><div class=\"col-xs-12\"><strong>Terrain features:</strong></div></div><div class=\"row\"><div class=\"col-xs-12\"><ul class=\"terrain-list\"><li ng-repeat=\"(name, value) in report.report.data.treelineTerrainAvoidance.terrainFeatures\" ng-class=\"{\'terrain-highlight\': value}\"><div class=\"row\"><div class=\"col-xs-2 terrain-icon\"><i ng-class=\"{\'fa-circle-o\': !value, \'fa-times-circle-o\': value}\" class=\"fa\"></i></div><div class=\"col-xs-10\"><span class=\"pull-left\">{{ name }}</span></div></div></li></ul></div></div></div></div><div class=\"row\"><div class=\"col-xs-12\"><strong>Comments</strong></div><div class=\"col-xs-12\">{{ report.report.data.treelineTerrainAvoidance.terrainAvoidanceComments || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-12\"><h4>BELOW TREELINE:</h4></div></div><div class=\"row\"><div class=\"col-xs-6\"><div class=\"row\"><div class=\"col-xs-12\"><strong>Aspect:</strong></div></div><div class=\"row\"><div class=\"col-xs-12\"><ul class=\"terrain-list\"><li ng-repeat=\"(name, value) in report.report.data.belowTreelineTerrainAvoidance.aspect\" ng-class=\"{\'terrain-highlight\': value}\"><div class=\"row\"><div class=\"col-xs-2 terrain-icon\"><i ng-class=\"{\'fa-circle-o\': !value, \'fa-times-circle-o\': value}\" class=\"fa\"></i></div><div class=\"col-xs-10\"><span class=\"pull-left\">{{ name }}</span></div></div></li></ul></div></div></div><div class=\"col-xs-6\"><div class=\"row\"><div class=\"col-xs-12\"><strong>Terrain features:</strong></div></div><div class=\"row\"><div class=\"col-xs-12\"><ul class=\"terrain-list\"><li ng-repeat=\"(name, value) in report.report.data.belowTreelineTerrainAvoidance.terrainFeatures\" ng-class=\"{\'terrain-highlight\': value}\"><div class=\"row\"><div class=\"col-xs-2 terrain-icon\"><i ng-class=\"{\'fa-circle-o\': !value, \'fa-times-circle-o\': value}\" class=\"fa\"></i></div><div class=\"col-xs-10\"><span class=\"pull-left\">{{ name }}</span></div></div></li></ul></div></div></div></div><div class=\"row\"><div class=\"col-xs-12\"><strong>Comments</strong></div><div class=\"col-xs-12\">{{ report.report.data.belowTreelineTerrainAvoidance.terrainAvoidanceComments || \'N/A\' }}</div></div></div></div><div class=\"panel panel-primary\"><div class=\"panel-heading\">More Information</div><div ng-bind-html=\"infoSummary\" class=\"panel-body\"></div></div></div></section></div></div></div>");
