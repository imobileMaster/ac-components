...
angular.module('acComponents.directives')
    .directive('acHotZoneMini', ["$state", function ($state) {
        return {
...
angular.module('acComponents.directives')
  .directive('acHotZoneReportFullPage', ["acReportData", function (acReportData) {
    return {
