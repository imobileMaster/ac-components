...
angular.module('acComponents.services')
    .factory('acForecast', ["$http", "acImageCache", function ($http, acImageCache) {
...
angular.module("acComponents.templates", []).run(["$templateCache", function($templateCache) {$templateCache.put("drawer.html","<div class=\"ac-drawer\"><a ng-click=\"drawer.visible = false\" class=\"ac-drawer-close visible-xs\"><i class=\"fa fa-close fa-lg\"></i></a><div class=\"ac-drawer-tools\"><ul><li ng-click=\"drawer.visible = !drawer.visible\"><i class=\"fa fa-file-text-o fa-fw fa-2x fa-inverse ac-middle\"></i></li><li ng-click=\"toggleFilter(\'obsType:incident\')\" ng-class=\"{on: filters.obsType.indexOf(\'incident\') !== -1}\"><i class=\"fa fa-warning fa-fw fa-2x fa-inverse ac-middle\"></i></li><li ng-click=\"toggleFilter(\'obsType:snowpack\')\" ng-class=\"{on: filters.obsType.indexOf(\'snowpack\') !== -1}\"><i class=\"fa fa-bar-chart fa-fw fa-2x fa-inverse ac-middle ac-icon ac-icon-avalanche\"></i></li><li ng-click=\"toggleFilter(\'obsType:simple\')\" ng-class=\"{on: filters.obsType.indexOf(\'simple\') !== -1}\"><i class=\"fa fa-camera fa-fw fa-2x fa-inverse ac-middle\"></i></li><li ng-click=\"toggleFilter(\'obsType:weather\')\" ng-class=\"{on: filters.obsType.indexOf(\'weather\') !== -1}\"><span class=\"ac-icon ac-icon-weather\"><i class=\"fa fa-sun-o fa-inverse fa-2x ac-middle\"></i><i class=\"fa fa-cloud fa-inverse fa-2x ac-middle\"></i></span></li><li ng-click=\"toggleFilter(\'obsType:avalanche\')\" ng-class=\"{on: filters.obsType.indexOf(\'avalanche\') !== -1}\"><span class=\"ac-icon ac-icon-avalanche\"><i class=\"fa fa-play fa-inverse fa-2x\"></i><i class=\"fa fa-cloud fa-inverse fa-1x\"></i></span></li><li ng-click=\"toggleFilter(\'obsPeriod:48-hours\')\" ng-class=\"{on: filters.obsType.length &gt; 0 &amp;&amp; filters.obsPeriod.indexOf(\'48-hours\') !== -1}\"><small>last </small><strong>48</strong><small>hours</small></li><li ng-click=\"toggleFilter(\'obsPeriod:7-days\')\" ng-class=\"{on: filters.obsType.length &gt; 0 &amp;&amp; filters.obsPeriod.indexOf(\'7-days\') !== -1}\"><small>last </small><strong>7 </strong><small>days</small></li><li ng-click=\"toggleFilter(\'obsPeriod:30-days\')\" ng-class=\"{on: filters.obsType.length &gt; 0 &amp;&amp; filters.obsPeriod.indexOf(\'30-days\') !== -1}\"><small>last </small><strong>30 </strong><small>days</small></li><li data-toggle=\"modal\" data-target=\"#obs\"><i class=\"fa fa-binoculars fa-fw fa-2x fa-inverse ac-middle\"></i></li></ul></div><div ng-transclude=\"ng-transclude\" class=\"ac-drawer-body\"></div></div>");
