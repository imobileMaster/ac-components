...
angular.module('acComponents.directives')
    .directive('acHotZoneMini', ["$state", "acHotZoneReportData", function ($state, acHotZoneReportData) {
        return {
