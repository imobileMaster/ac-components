...
$templateCache.put("spring-conditions.html","<div class=\"col-xs-12\"><div class=\"panel panel-primary\"><div class=\"panel-heading\">Spring Conditions: {{ forecast.dangerRatings[0].date | dateUtc:\'dddd\' }}</div><div class=\"panel-body spring-conditions\"><div class=\"col-xs-4\"><img style=\"max-width:90%\" src=\"http://www.avalanche.ca/assets/images/spring_situation_icon.svg\"/></div><div class=\"col-xs-8\"><ac-spring-conditions-text/></div></div></div></div>");
$templateCache.put("summer-conditions-text.html","<p>Avalanche forecasts have ended for the season and will return with the snow in\nthe fall. Look for the first one sometime in November.\n</p><p>Field Observations for your area may be available at the Association of\nCanadian Mountain Guides (ACMG) Mountain Conditions Report Website: <a\nhref=\"http://www.mountainconditions.com/\"\ntarget=\"_blank\">http://www.mountainconditions.com/</a> \n</p><p>The ACMG also provides\nweekly Mountain Conditions Summaries: <a\nhref=\"http://www.acmg.ca/mcr/summeries.asp\" target=\"_blank\">http://www.acmg.ca/mcr/summeries.asp</a>\n</p><p>More detailed information on managing conditions in the spring and summer:\n<a href=\"http://avalanche.ca/spring\">http://avalanche.ca/spring</a></p>");
$templateCache.put("summer-conditions.html","<div class=\"col-xs-12\"><div class=\"panel panel-primary\"><div class=\"panel-heading\">Summer Conditions: {{ forecast.dangerRatings[0].date | dateUtc:\'dddd\' }}</div><div class=\"panel-body summer-conditions\"><div class=\"col-xs-4\"><img style=\"max-width:90%\" src=\"http://www.avalanche.ca/assets/images/summer_conditions_icon.svg\"/></div><div class=\"col-xs-8\"><ac-summer-conditions-text/></div></div></div></div>");
