...
angular.module('acComponents.directives')
    ...
    .directive('acMinReportForm', ["$state", "$rootScope", "$q", "$timeout", "acBreakpoint", "acQuickReportData", "acAvalancheReportData", "acIncidentReportData", "acSnowpackReportData", "acWeatherReportData", "acFormUtils", "acSubmission", "MAPBOX_ACCESS_TOKEN", "MAPBOX_MAP_ID", "store", "$anchorScroll", "$modal", function($state, $rootScope, $q, $timeout, acBreakpoint, acQuickReportData, acAvalancheReportData, acIncidentReportData, acSnowpackReportData, acWeatherReportData, acFormUtils, acSubmission, MAPBOX_ACCESS_TOKEN, MAPBOX_MAP_ID, store, $anchorScroll, $modal) {
        return {
