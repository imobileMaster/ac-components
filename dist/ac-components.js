...
angular.module('acComponents.directives')
    ...
    .directive('acForecastMiniParksLinks', ["AC_API_ROOT_URL", function (AC_API_ROOT_URL) {
        return {
            restrict: 'E',
            scope: { 
                forecast: '=',
...
$templateCache.put("forecast-mini-parks-links.html","<div class=\"parks-links\">This is where the parks links for: {{forecast.region}} / {{links}}</div>");
...
$templateCache.put("forecast-mini.html","<div class=\"panel\"><div ng-show=\"forecast.externalUrl\"><ac-forecast-mini-external forecast=\'forecast\' /></div><div ng-hide=\"forecast.externalUrl\"><ac-forecast-mini-avalx forecast=\'forecast\' danger-rating=\'dangerRating\' disclaimer=\'disclaimer\' sponsor=\'sponsor\' /></div></div>");
