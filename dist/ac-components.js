...
angular.module('acComponents.services')
    .factory('acHotZone', ["$http", "$q", "acImageCache", "AC_API_ROOT_URL", function ($http, $q, acImageCache, AC_API_ROOT_URL) {
        var hotZones;
