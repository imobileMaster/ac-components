...
$templateCache.put("hot-zone-mini.html","<div class=\"panel\"><div class=\"panel-body ac-forecast-mini-body\"><div class=\"row\"><div class=\"col-xs-12\"><h4 class=\"ac-forecast-region\">{{ region.name }} Pilot Project</h4></div></div><div class=\"row ac-forecast-dates\"><div class=\"col-md-6\"><dl><dd class=\"small\"><strong class=\"ac-text-primary\">DATE ISSUED</strong></dd><dt class=\"small\"><span class=\"ac-text-default\">{{ hotZone.dateissued || \'N/A\'| date:\'EEEE MMMM d, y h:mm a\'  | uppercase }}</span></dt></dl></div><div class=\"col-md-6\"><dl><dd class=\"small\"><strong class=\"ac-text-primary\">VALID UNTIL</strong></dd><dt class=\"small\"><span class=\"ac-text-default\">{{ hotZone.datevalid || \'N/A\'| date:\'EEEE MMMM d, y h:mm a\' | uppercase }}</span></dt></dl></div></div><div ng-if=\"hotZone !== &quot;default&quot;\" class=\"row\"><div class=\"col-xs-12\"><h3 class=\"ac-hot-zone-headline\">{{ hotZone.report.headline }}</h3></div></div><div ng-if=\"hotZone === &quot;default&quot;\" class=\"row\"><div class=\"col-xs-12\"><h3 class=\"ac-hot-zone-headline\">No data for this hot zone</h3></div></div><div ng-if=\"hotZone.report.uploads.length &gt; 0\" class=\"row\"><div class=\"col-sm-12 section-label\"><i class=\"fa fa-camera\"></i><span>   Uploads (click/tap to enlarge)</span></div><div class=\"col-sm-12\"><ul class=\"list-inline\"><li ng-repeat=\"url in hotZone.report.thumbs\"><a ng-href=\"{{url}}\" target=\"_blank\"></a><img ng-src=\"{{url}}\" width=\"75\" alt=\"{{hotZone.report.headline}}\"/></li></ul></div></div><div class=\"row\"><div class=\"col-xs-12\"><div id=\"infoAccordion\" class=\"panel-group\"><div ng-if=\"hotZone !== &quot;default&quot;\" class=\"panel panel-primary\"><div class=\"panel-heading\"><h4 class=\"panel-title\"><a href=\"\" data-target=\"#criticalSummary\" data-toggle=\"collapse\" data-parent=\"#infoAccordion\">Critical Factors Summary<i class=\"fa fa-fw fa-level-down fa-lg pull-right\"></i><small class=\"pull-right\">click to expand</small></a></h4></div><div id=\"criticalSummary\" class=\"panel-collapse collapse\"><div class=\"panel-body\"><div class=\"row\"><div class=\"col-xs-12\">Critical factors influence avalanche hazard. The more critical factors, the greater the potential for avalanches.</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Persistent avalanche problem:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.criticalFactors.persistentAvalancheProblem || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Slab avalanches in the last 48 hours:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.criticalFactors.slabAvalanches || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Signs of instability:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.criticalFactors.instability || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\"> Recent snowfall > 30cm:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.criticalFactors.recentSnowfall || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\"> Recent rainfall:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.criticalFactors.recentRainfall || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\"> Recent windloading:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.criticalFactors.recentWindloading || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\"> Significant warming:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.criticalFactors.significantWarming || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Comments:</strong></div><div class=\"col-xs-6\">{{ criticalFactorsComments || \'N/A\' }}</div></div></div></div></div><div ng-if=\"hotZone !== &quot;default&quot;\" class=\"panel panel-primary\"><div class=\"panel-heading\"><h4 class=\"panel-title\"><a href=\"\" data-target=\"#terrainSummary\" data-toggle=\"collapse\" data-parent=\"#infoAccordion\">Terrain Recommendations<i class=\"fa fa-fw fa-level-down fa-lg pull-right\"></i><small class=\"pull-right\">click to expand</small></a></h4></div><div id=\"terrainSummary\" class=\"panel-collapse collapse\"><div class=\"panel-body\"><div class=\"row\"><div class=\"col-xs-12\">Based on the critical factors, AVOIDING the following is recommended to reduce risk.</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Aspect:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.terrainAvoidanceList.aspect || \'N/A\' | acFormatList }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Elevation band:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.terrainAvoidanceList.elevationBand || \'N/A\' | acFormatList }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Elevation below:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.terrainAvoidanceList.elevationBelow || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Elevation above:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.terrainAvoidanceList.elevationAbove || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Elevation between:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.terrainAvoidanceList.elevationBetweenLow || \'N/A\' }} and {{ hotZone.report.data.terrainAvoidanceList.elevationBetweenHigh || \'N/A\' }} metres</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Terrain features:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.terrainAvoidanceList.terrainFeatures || \'N/A\' | acFormatList }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Slopes steeper than:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.terrainAvoidanceList.steeperThan || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Other terrain features:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.terrainAvoidanceList.otherTerrainFeatures || \'N/A\' }}</div></div><div class=\"row\"><div class=\"col-xs-6\"><strong class=\"pull-right text-right\">Comments:</strong></div><div class=\"col-xs-6\">{{ hotZone.report.data.terrainAvoidanceList.terrainAvoidanceComments || \'N/A\' }}</div></div></div></div></div><div ng-if=\"hotZone !== &quot;default&quot;\" class=\"panel panel-primary\"><div class=\"panel-heading\"><h4 class=\"panel-title\"><a href=\"\" data-target=\"#travelSummary\" data-toggle=\"collapse\" data-parent=\"#infoAccordion\">Travel Advice<i class=\"fa fa-fw fa-level-down fa-lg pull-right\"></i><small class=\"pull-right\">click to expand</small></a></h4></div><div id=\"travelSummary\" class=\"panel-collapse collapse\"><div class=\"panel-body\"><p>{{ hotZone.report.data.travelAdvice.travelAdviceStatement1 }}</p><p>{{ hotZone.report.data.travelAdvice.travelAdviceStatement2 }}</p><p>{{ hotZone.report.data.travelAdvice.travelAdviceStatement3 }}</p><p>{{ hotZone.report.data.travelAdvice.travelAdviceComments }}</p></div></div></div><div style=\"margin-bottom: 10px;\" class=\"panel panel-primary\"><div class=\"panel-heading\"><h4 class=\"panel-title\"><a href=\"\" data-target=\"#infoSummary\" data-toggle=\"collapse\" data-parent=\"#infoAccordion\">About<i class=\"fa fa-fw fa-level-down fa-lg pull-right\"></i><small class=\"pull-right\">click to expand</small></a></h4></div><div id=\"infoSummary\" class=\"panel-collapse collapse\"><div ng-bind-html=\"infoSummary\" class=\"panel-body\"></div></div></div></div></div></div></div></div>");
