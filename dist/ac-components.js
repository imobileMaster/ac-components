      ...
      link: function ($scope, el, attrs) {
        ...
        function refreshLayers() {
          ...
          if (layers.regions && $scope.showRegions) {
            ...
            } else if (zoom > 20 && regionsVisible) {
              map.removeLayer(layers.regions);
            }
          }
